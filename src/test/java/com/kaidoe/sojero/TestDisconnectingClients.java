...
public class TestDisconnectingClients
{
    ...
    class TestConsumer implements Runnable
    {
        ...
        public void run() {
            ...
            provider.addHandler(new CounterEventHandler("Message", this));
    ...
    public void main() throws InterruptedException {
        ...
        t1.start();
        Thread t2 = new Thread(p1, "Provider");
        t2.start();
        Thread t3 = new Thread(p2, "Provider");
        t3.start();
        ...
        Thread t4 = new Thread(p3, "Provider");
        t4.start();
        t4.join();
